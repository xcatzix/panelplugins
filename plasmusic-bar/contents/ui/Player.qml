...
QtObject {
    ...
    readonly property bool hasActiveMedia:
        ready && (playbackStatus === Mpris.PlaybackStatus.Playing || playbackStatus === Mpris.PlaybackStatus.Paused)
    readonly property string identity: ready ? mpris2Model.currentPlayer.identity : ""
    readonly property real songPosition: ready && mpris2Model.currentPlayer.position !== undefined
        ? mpris2Model.currentPlayer.position : 0
    readonly property real songLength: ready && mpris2Model.currentPlayer.length !== undefined
        ? mpris2Model.currentPlayer.length : 0
